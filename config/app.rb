...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'simple-public-timeline.com'
  config.app_name = 'Simple_public_timeline'
  config.mailer.from = 'Simple_public_timeline <no-reply@simple-public-timeline.com>'
  ...
  #
  config.app_secret = 'SYfHh6DZkBhtF0vn-9QnFPLcgWKtaUzyZmKF6nbxB77IzHCb_bkPGOV1_mxurx9dfA4'
